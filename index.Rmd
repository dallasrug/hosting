...
<script>
    ...
    $(document).ready(function() {
        ...
        window.setInterval(loopSlides, delay = 10000);
    })
</script>
...
<https://www.meetup.com/Dallas-R-Users-Group/events/259461095/>

<br>
Thank you **University of Dallas** for hosting us and WiFi

- **Network: UDairguest** / Open a browser and click Accept


## Dallas RUG - News

- Plannig meeting (Feb 2) minutes available on GitHub
...
- (**extra**) move past meetup files to Dallas RUG GitHub
